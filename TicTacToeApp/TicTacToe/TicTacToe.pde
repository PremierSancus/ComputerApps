void setup() {
  ...
  rect(width*196/240,height*2/240,width*40/240,height*18/240);//quit button rectangle
  ...
  rect(width*139/240,height*27/240,width*40/240,height*19/240);//score for O
